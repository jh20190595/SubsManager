        ...
        <div className={styles.container}>
            <div className={styles.inputTop}>
                <div className={styles.btnWrap}>
                    ...
                    />
                    <button className ={activeTap === 'all' ? styles.activeTap : '' } onClick={() => handleTapChange('all') }><span >All items</span></button>
                    <button className ={activeTap === 'sub' ? styles.activeTap : '' } onClick={() => handleTapChange('sub')}><span >Subscriptions only</span></button>
                </div>
                <input
                    value={value}
                    onChange={(e) => onSearch(e.target.value)}
                    placeholder='영어로 검색어를 입력하세요'
